...
<<<<<<< HEAD
    ...
    task = "test"
    images_dir = f"/media/Datacenter_storage/Ji/brain_mri_valdo_mayo/mayo_yolo_t2s_only_rotated_GAN/images/{task}"
    labels_dir = f"/media/Datacenter_storage/Ji/brain_mri_valdo_mayo/mayo_yolo_t2s_only_rotated_GAN/labels/{task}"
...
>>>>>>> 69d17e4d600524a74a931801ef46d0a744d923af
