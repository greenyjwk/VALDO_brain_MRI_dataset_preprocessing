...
#             negative_boxes = generate_negative_samples(csf_mask, image, box_size=BOX_SIZE)
...
#     output_labels_path = f"/mnt/storage/ji/brain_mri_valdo_mayo/TEMP3_train/labels/{task}"
