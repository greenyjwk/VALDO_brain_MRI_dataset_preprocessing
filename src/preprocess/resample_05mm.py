...
def resample_image(image, new_spacing=[0.5, 0.5, 0.5], is_mask=False):
    """
...
if __name__ == "__main__":
    ...
    output_root_path = "/media/Datacenter_storage/PublicDatasets/cerebral_microbleeds_VALDO/TEMP"
